...
public class Finprod {
    @Id
    @Column(name = "finprod_id", nullable = false, columnDefinition = "number")
    ...
    @Column(name="order_id", nullable = false, columnDefinition = "number")
    private Long orderId;    //수주 고유번호

    @Column(name="finprod_ea", nullable = false, columnDefinition = "number")
